...
func (in *BindingComponent) DeepCopyInto(out *BindingComponent) {
	*out = *in
	...
	if in.Components != nil {
		...
		*out = make([]BindingComponentConfiguration, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BindingComponentGitOpsRepostory) DeepCopyInto(out *BindingComponentGitOpsRepostory) {
	*out = *in
}
...
func (in *BindingComponentGitOpsRepostory) DeepCopy() *BindingComponentGitOpsRepostory {
	if in == nil {
		return nil
	}
	out := new(BindingComponentGitOpsRepostory)
	in.DeepCopyInto(out)
	return out
}
