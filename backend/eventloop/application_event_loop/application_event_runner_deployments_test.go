...
// var _ = Describe("Test to check namespace consistency of OperationCR with GitopsEngineInstance", func() {
// 	Context("Operations should exist only in the namespace of argocd Instance", func() {
// 		var err error
// 		var workspaceID string
// 		var ctx context.Context
// 		var scheme *runtime.Scheme
...
// 		FIt("OperationCRs with namespaces not consistent with gitopsEngineInstance should be ignored.", func() {
...
// 					}
// 					err = dbQueries.GetGitopsEngineInstanceById(ctx, &engineInstance)
// 					Expect(err).To(BeNil())
// 					getOperation := db.Operation{}
...
// 						if operation.Resource_id == application.Application_id {
// 							getOperation = operationsList[idx]
// 						}
// 					}
...
// 					getOperation.State = db.OperationState_Waiting
// 					err = dbQueries.UpdateOperation(ctx, &getOperation)
// 					Expect(err).To(BeNil())

// 					operationCR := &managedgitopsv1alpha1.Operation{}
// 					for _, operation := range operationList.Items {
// 						if operation.Spec.OperationID == getOperation.Operation_id {
// 							operationCR = &operation
// 						}
// 					}
// 					Expect(operationCR).ToNot(BeNil())
// 					Expect(operationCR.Namespace).To(Equal(engineInstance.Namespace_name))

// 					operationCR.Namespace = "invalid-namespace"
// 					err = k8sClient.Update(ctx, operationCR)
